...
Begin VB.Form Form17 
   ...
   Begin VB.ComboBox class 
      ...
      EndProperty
      Height          =   375
      ItemData        =   "Class_update.frx":0000
      Left            =   120
      List            =   "Class_update.frx":0019
   ...
   Begin VB.ComboBox section 
      ...
      EndProperty
      Height          =   375
      ItemData        =   "Class_update.frx":0042
      Left            =   3120
      List            =   "Class_update.frx":004F
      Style           =   2  'Dropdown List
      TabIndex        =   3
      Top             =   5160
      Width           =   2655
   ...
   Begin VB.ComboBox teacher 
      ...
      EndProperty
      Height          =   375
      ItemData        =   "Class_update.frx":005C
      Left            =   6120
      List            =   "Class_update.frx":0066
      Style           =   2  'Dropdown List
      TabIndex        =   2
      Top             =   5160
      Width           =   2655
   End
   Begin VB.CommandButton update_sub 
      Caption         =   "UPDATE"
      BeginProperty Font 
         Name            =   "Nirmala UI"
         Size            =   9.75
